...
export SERVER_NAME APP_UPSTREAM APP_BASE_PATH CLIENT_MAX_BODY_SIZE BASIC_AUTH_ENABLED BASIC_AUTH_FILE TLS_CERT_PATH TLS_KEY_PATH

envsubst '${SERVER_NAME} ${APP_UPSTREAM} ${APP_BASE_PATH} ${CLIENT_MAX_BODY_SIZE} ${BASIC_AUTH_ENABLED} ${BASIC_AUTH_FILE} ${TLS_CERT_PATH} ${TLS_KEY_PATH}' \
